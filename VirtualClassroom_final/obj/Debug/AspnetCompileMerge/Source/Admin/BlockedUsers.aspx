...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  <div id ="BlockedUser" algin="center" runat = "server" class="">
      <table align="center">
          <tr>
              <td>
                  <asp:Label ID="lblmessage" runat="server" CssClass="label label-success offset6" Font-Bold="true" Font-Size="Larger" ForeColor="White" ></asp:Label>
              </td>
          </tr>
      </table>
    <asp:GridView ID="GridView3" runat="server" AutoGenerateColumns="false" 
         ...
         <AlternatingRowStyle BackColor="#DCDCDC" />  
              <Columns>
                ...
                <EditItemTemplate >
                <asp:Textbox ID="txtlock" runat="server" Text='<%# Eval("lock") %>' ></asp:Textbox>
                <%--<asp:Label ID="lblemail" runat="server" Text='<%# Eval("email") %>' ></asp:Label>--%>
                </EditItemTemplate>
                 </asp:TemplateField>
...
<div style="margin-left:360px; margin-top:-235px;">

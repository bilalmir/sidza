...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="row" style="margin-top:150px;margin-bottom:90px;">
       ...
       <table align="center" ><tr><td><asp:Label ID="lblmsgg" CssClass="label-important" Font-Bold="true"  runat="server"></asp:Label></td></tr></table>  <br />
          ...
          <asp:GridView ID="GridView2" runat="server"  
             AutoGenerateColumns="False" Height="100px" BackColor="White"
                ...
                EmptyDataText="There are no Subjects" Visible="True" OnRowDeleting="GridView2_RowDeleting"
                 ForeColor="black" Caption="Active Users" CssClass="table table-responsive table-condensed">

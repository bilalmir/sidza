<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WhiteboardLaunch.aspx.cs" Inherits="VirtualClassroom_final.whiteboard.WhiteboardLaunch" %>
...
<base href="#" />
    ...
    <link rel="stylesheet" type="text/css" href="../whiteboard/easyui.css">
    <link rel="stylesheet" type="text/css" href="../whiteboard/icon.css">
    <link rel="stylesheet" type="text/css" href="../whiteboard/lightslider.css">
    <link rel="stylesheet" type="text/css" href="../whiteboard/whiteboard.css">  
    <link href="../whiteboard/font-awesome-4.7.0/css/font-awesome.min.css" rel="stylesheet" />
    ...
    <script src="../whiteboard/jquery.js"></script> 
    <script src="../whiteboard/jquery.easyui.min.js"></script>
    <script src="../whiteboard/fabric-min.js"></script>
    <script src="../whiteboard/screenfull.js"></script>
    <script src="../whiteboard/ion.sound.min.js"></script>
    <script src="../whiteboard/rmc3.min.js"></script>
    <script src="../whiteboard/rmc3.fbr.min.js"></script>
    <script src="../whiteboard/socket.io.js"></script>
    <link rel="stylesheet" type="text/css" href="../whiteboard/slick.css" />
    <link rel="stylesheet" type="text/css" href="../whiteboard/slick-theme.css" />
    <script type="text/javascript" src="../whiteboard/slick.min.js"></script>
    <script type="text/javascript" src="../whiteboard/bootstrap.min.js"></script>
...
<div class="wrapLoader">
   <div class="imgLoader">
       <img src="../whiteboard/loading.gif" alt="" width="70" height="70" />
      <div id="wait"></div>
   </div>
</div>
            ...
            <div id="myCarousel" class="carousel slide" data-ride="carousel">  
               ...
               <div class="carousel-inner bigbanner">
                  <div class="item active">			
                      <img src="../whiteboard/live-video-chat.jpg" title="Live Video Chat">
                  </div>
                  <div class="item">	
                      <img src="../whiteboard/upload_presentations.jpg" title="Upload Presentations">
                  </div>
                  <div class="item">	
                      <img src="../whiteboard/online_presentation.jpg" title="Online Presentations">
                  </div>
                  <div class="item">
                      <img src="../whiteboard/upload-download-presentation.jpg" title="Upload/Download Presentation">
                  </div>
                  <div class="item active">			
                      <img src="../whiteboard/change-background.jpg" title="Change Background Color">
                  </div>
                  <!-- Carousel controls -->
...
<div data-options="region:'north'" style="height:65px; width:100%;overflow:hidden;">   
   ...
   <a href='#'>
       <img src="../img/logo.jpg" height="50px" style="padding:5px; float:left;" />
   </a>
   ...
   <div style="margin:18px 0px 0px 0px;">
      <div class="db-nav">
          <a href="javascript:void(0);" id="CreateRoom" style="display:none;" title="CreateRoom">
              <div class="sub-default-lft" style="border-right:none;"><i class=" fa-mouse-pointer wbitem"></i></div>
          </a>
         ...
         <a href='javascript:void(0)'  title="Clear all" class="clrDynamicCanvas">
            <div class="sub-default-lft wbitem" style="border-right:none;"><img src="../whiteboard/clear.png" style="vertical-align:bottom; height:17px;" /></div>
         </a>
         ...
         <a href="javascript:void(0);" id="ancHelpMain" style="display:none;" title="Help Whiteboard">
           <div class="sub-default-lft" style="border-right:none;"><img src="../whiteboard/help.png" /></div>
         </a>      
      </div>
   </div> 
      ...
      <div class="wr-lft-cont column">
         <div class="sub-default clickDisable" id="lftMainmenu">
             ...
             <a href="javascript:void(0);" id="ancPattern" title="Pattern">
               <div class="sub-default-lft" ><img src="../whiteboard/pattern-icon.png" style="border:1px solid #ccc;border-radius:60px;" /></div>
             </a>
             ...
             <a href="javascript:void(0);" id="ancShape" title="Shapes">
               <div class="sub-default-lft" style="border-right:none;"><img src="../whiteboard/shape-sm.png" /></div>
             </a>
            ...
            <a href="javascript:void(0);" id="ancTutorConnect" style="display:none;" title="Tutor Connect Content Presentation">
               <div class="sub-default-lft" style="border-right:none;"><img src="../whiteboard/image-editor.png" /></div>
            </a>             
            <a href="javascript:void(0);" id="ancStartChat" style="display:none;" title="Meeting">
               <div class="sub-default-lft" style="border-right:none;"><img src="../whiteboard/chat_room.png" /></div>
            </a> 		             
            <a href="javascript:void(0);" id="ancDownload" style="display:none;" title="Download/Upload">
               <div class="sub-default-lft" style="border-right:none;"><img src="../whiteboard/up-down.png" /></div>
            </a> 		   
...
<!--BOTTOM STARTS -->
<div id="south" data-options="region:'south',iconCls:'icon-image-editor', title:'Slides', split:false,collapsible:true" style="height:115px;display:none;">
</div>
<!--BOTTOM ENDS -->
...
<div id="center" data-options="region:'center'" style="height:100%">
         ...
         <div class="subProperties left-meni-slide" id="bgPattern" style="min-height:312px; max-height:100%;">
           ...
           <div class="sub-tools items">
              <a href="javascript:void(0);" class='clsBgColor bgcrcle h30' title="Guidelines">
                 <div class="bgclpkr bgpatterns"><img src="../whiteboard/transparent-guidelines.png" /></div>
              </a>
              <a href="javascript:void(0);" class='clsBgColor bgcrcle h30' title="Book Guidelines">
                 <div class="bgclpkr bgpatterns"><img src="../whiteboard/transparent-booklines.png" /></div>
              </a>
              <a href="javascript:void(0);" class='clsBgColor bgcrcle h30' title="Transparent Background">
                 <div class="bgclpkr bgpatterns"><img src="../whiteboard/transparent.png" /></div>
              </a>
              <a href="javascript:void(0);" class='clsBgColor bgcrcle h30' title="Guidelines">
                 <div class="bgclpkr bgpatterns"><img src="../whiteboard/transparent-diamond.png" /></div>
              </a>
              <a href="javascript:void(0);" class='clsBgColor bgcrcle h30' title="Book Guidelines">
                 <div class="bgclpkr bgpatterns"><img src="../whiteboard/transparent-lgap.png" /></div>
              </a>
              <a href="javascript:void(0);" class='clsBgColor bgcrcle h30' title="Transparent Background">
                 <div class="bgclpkr bgpatterns"><img src="../whiteboard/transparent-checkered.png" /></div>
              </a>   
         ...
         <div class="subProperties left-meni-slide" id="downloadOptions" style="min-height:145px; max-height:100%;">
            ...
            <div class="sub-tools items">
              <a href='javascript:void(0)' id="ancDwnJson" title="Download as Board" >
                  <img src="../whiteboard/download_board.png" class="fa-dwnload" style="width:21px; height:22px;border-radius:0px;" /></a>
              <a href='javascript:void(0)' id="ancDwnJpeg" title="Download as JPEG">
                  <img src="../whiteboard/download_jpeg.png" class="fa-dwnload" style="width:21px; height:22px;border-radius:0px;" /></a>                           
   ...
   <div id="helpWindow" class="easyui-window" title="Help Guide for Whiteboard" data-options="iconCls:'icon-help'" style="width:955px;height:500px;">
    ...
    <script src="../whiteboard/lightslider.js"></script>
<script>
$(document).ready(function(event) {
    ...
    */
    ...
    $("#CreateRoom").bind("click", function (e) {
       //var randomurl = Math.random().toString(36).substring(2, 15) + Math.random().toString(36).substring(2, 15);
        //window.location.href = window.location.href + "?roomid=" + randomurl;
        alert('hello whiteboard');
        var urlParams = new URLSearchParams(window.location.search);
        room_id = urlParams.get('roomid');       
        user_name = urlParams.get('u_name');
      //  room_id = "llzgri7g9fjcxuz8dptb2";
       // user_name = "bilal";
    ...
    function setupWebRTC() {
      ...
      //  connection.maxParticipantsAllowed = 1; // one-to-one
        ...
        connection.extra.user_name = person;
...
//        updateContainerUserFaces();
 ...
 //  To sync drawings on each board ( By Mir Bilal)
...
//    });
    ...
    function adjustBigVideo() {
        ...
        if (connection.extra.enabledVideo) {
            ...
            //playing the video
            setTimeout(function() {
                document.getElementById(localStream.streamid).load();
        ...
        connection.getAllParticipants().forEach(function(userid) {
            ...
            if (remotePeer.extra.enabledVideo && remotePeer.streams.length != 0) {
                ...
                setTimeout(function() {
                    ...
                    document.getElementById(remoteStream.streamid).load();
                }, 5000);
            } else {

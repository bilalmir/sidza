                        ...
                        <div class="modal-body">
                          ...
                          Format="dd/MM/yyyy"></aa:CalendarExtender><button class="glyphicon glyphicon-calendar" id="imgPopup"></button>                            
                            ...
                            <div class="modal-footer">
                                <asp:Button ID="btnSetClassSchedule" runat="server" CssClass="btn btn-primary" ValidationGroup="btnSetClassSchedule" Text="Set Schedule" OnClick="btnSetClassSchedule_Click" />

      ...
      <div class="col-md-8 col-md-offset-2" >
         <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
          ...
          <table align="center">
            ...
            <tr>
                <td><asp:Label ID="lblclass" runat="server" Text="Class Name:"></asp:Label></td>
                <td>
                      <asp:DropDownList ID="ddlclass2" runat="server" CssClass="form-control" OnSelectedIndexChanged="ddlclass2_SelectedIndexChanged" AutoPostBack="true">
                      </asp:DropDownList>              
                </td>
            </tr>
              <tr>
                <td><asp:Label ID="lblsubject2" runat="server" Text="Subject Name:"></asp:Label></td>
                <td><asp:DropDownList ID="ddlsubject2" runat="server" CssClass="form-control" OnSelectedIndexChanged="ddlsubject2_SelectedIndexChanged" AutoPostBack="true" >
                          </asp:DropDownList>             
                </td>
            </tr>
              <tr>
                <td><asp:Label ID="lblchapter1" runat="server" Text="Chapter Name:"></asp:Label></td>
                <td>
                      <asp:DropDownList ID="ddllesson" runat="server" CssClass="form-control"></asp:DropDownList>
            
                </td>
            </tr>
            <tr>
                <td><asp:Label ID="Label3" runat="server" Text="Title Name:"></asp:Label></td>
                <td>

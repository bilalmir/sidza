...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="img-responsive dvbg"></div>
        </div>
    </div>
    <div class="row" id="C4">
    ...
    <div class="row" id="divsearchTeacher" runat="server">
        <div class="col-md-12">
            <div style="color: white; font-size: 35px; font: bold; margin-top: 50px; text-align: center; background-color: black; opacity: 0.9;" class="img-rounded">
                <label class="img-rounded">Choose from our online tutors</label>
            </div>
                    ...
                    <asp:TemplateField ItemStyle-CssClass="pull-left">
                        <ItemTemplate>
                            <div style="font-size: larger; font-weight: bold">
                                <span>Name: </span>
                                <asp:Label ID="lblusername" runat="server" CssClass="label label-info" Text='<%# Eval("name") %>'></asp:Label>
                            </div>
                            <div style="margin-top: 20px; font-size: larger; font-weight: bold">
                                <span>Subject: </span>
                                <asp:Label ID="lblusersubject" runat="server" CssClass="label label-info" Text='<%# Eval("teacherSubject") %>'></asp:Label>
                            </div>
                        </ItemTemplate>
                    </asp:TemplateField>

...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row" style="margin-top: 30px;">
        <div class="col-md-4 col-md-offset-1" style="margin-top: 35px;">
            <h3>
                <asp:Label ID="lblscheduleclass" runat="server" CssClass="label label-success" Text="List of class Session(s)"></asp:Label></h3>
        </div>
                ...
                <ContentTemplate>
                    <asp:GridView ID="grdvwShowSessions" runat="server" CaptionAlign="Top" PageSize="10" AllowPaging="true" CssClass="table table-responsive table-hover"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField>
                                <ItemTemplate>
                                    <span class="glyphicon glyphicon-time" id="tmIcon" runat="server"></span>
                                    <asp:Label ID="lbltimefrom" runat="server" Style="font-size: large;" Text='<%# Eval("timefrom") %>'></asp:Label>

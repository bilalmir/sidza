...
{
    public partial class QuestionsPapers : System.Web.UI.Page
    {
        ...
        protected void ddlsubject_SelectedIndexChanged(object sender, EventArgs e)
        {
             try
            {
                if (Session["email"] != null)
                {
                    ...
                    grddownloadmaterial.DataSource = UserBL.FetchQuestionPapers(classid, subjectid, 4);
        ...
        protected void grddownloadmaterial_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                ltrfile.Text = ltrfile.Text.Substring(23);
                ...
                //LinkButton lnkfilename = (LinkButton)e.Row.Cells[1].FindControl("lnkbtnFile");
                //lnkfilename.Text = lnkfilename.Text.Substring(15);
                //lnkfilename.Text = lnkfilename.Text.Remove(lnkfilename.Text.Length - 4);
            }
        }

...
namespace Logic.BL
{
    ...
    public class UserBL
    {
       ...
       /// Remark : : Fetch all roles for the dropdown list (User) in the Register Page...
        ...
        {
            return UserDL.ScheduleClass(teacheremail, studentemail, subject, topic, grade, date, timefrm, timeto,link);
        }
        ...
        {
            return UserDL.FetchStudentProfile(email);
        }
        public static DataSet FetchScheduledClasses(string email)
        {
            return UserDL.FetchScheduledClasses(email);
        }
        public static DataRow getTeacherProfile(string teacheremail)
        {
            return UserDL.getTeacherProfile(teacheremail);
        }

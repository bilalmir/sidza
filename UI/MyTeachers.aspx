<%@ Page Title="" Language="C#" MasterPageFile="~/UI/Home.Master" AutoEventWireup="true" CodeBehind="MyTeachers.aspx.cs" Inherits="VirtualClassroom_final.UI.MyTeachers" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="row" >
        <div class="col-md-8 col-md-offset-2" id="showprofile" runat="server" visible="false">        
            <asp:GridView ID="grdvwMyTeachers" runat="server" CaptionAlign="Top" PageSize="10" AllowPaging="true" CssClass="table table-responsive"
                AutoGenerateColumns="False" Height="100px" BackColor="White"  CellPadding="3"
                CellSpacing="2" GridLines="None"  OnPageIndexChanging="grdvMyTeachers_PageIndexChanging"
                EmptyDataText="There is no material available" OnSelectedIndexChanged="grdvwMyTeachers_SelectedIndexChanged">
                ...
                <Columns>
                    <asp:TemplateField HeaderStyle-CssClass="invisible" ItemStyle-CssClass="invisible">
                     ...
                     <asp:TemplateField ItemStyle-CssClass="text-center">
                                 <ItemTemplate>
                           <asp:Button ID="btnShowTeacherProfile" runat="server" Text="View Profile" CssClass="btn btn-success form-control" />
                        </ItemTemplate>
                    </asp:TemplateField>                    
                </Columns>
